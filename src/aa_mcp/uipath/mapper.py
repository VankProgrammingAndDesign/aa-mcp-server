...
ACTIVITY_MAP: dict[tuple[str, str], ActivityMapping] = {
    ...
    ("loop",    "loop.commands.break"):  ActivityMapping(PARTIAL,  "Break",                     None,                                    "Add a UiPath Break activity"),
    ("loop", "loop.commands.continue"):  ActivityMapping(PARTIAL,  "Continue",                  None,                                    "Add a UiPath Continue activity"),
    ...
    ("errorhandler", "throw"):           ActivityMapping(MAPPED,   "Throw",                     None,                                    "Raise / re-throw an exception"),
